...
export function ScoreCard({ score, summary }: ScoreCardProps) {
  ...
  return (
    <div className="h-full rounded-2xl bg-background border border-border p-8 shadow-sm">
      <h2 className="mb-8 text-sm font-medium uppercase tracking-wider text-muted-foreground">AI Readiness Score</h2>
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-center text-sm text-muted-foreground leading-relaxed">{summary}</p>
      </div>
    </div>
  )
}
