...
const phaseTitles = {
  ...
  "Agent Guidance Layer": "Publish What Agents Can Read",
  "AI Content Quality": "Improve What AI Can Explain",
  "AI Integrations": "Turn Platform Potential Into Real Capability",
  "MCP Compatibility": "Make Autonomous Commerce Actions Work Reliably",
